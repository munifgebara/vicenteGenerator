...
module.exports = function (config) ={
  ...
  `;
  util.escreveArquivo(`${angularPath}/src//karma.conf.js`, src, `utf8`);
}
  ...
  let src = `
{
  ...
  `;
  util.escreveArquivo(`${angularPath}/src//tsconfig.app.json`, src, `utf8`);
}
  ...
  let src = `
{
  ...
  `;
  util.escreveArquivo(`${angularPath}/src//tsconfig.spec.json`, src, `utf8`);
}
